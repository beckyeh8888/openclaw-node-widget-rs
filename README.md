...
- 🔔 **Notifications** — Desktop alerts when your node goes online or offline
...
- ⚡ **Lightweight** — ~3MB native binary, minimal resource usage
...
<!-- TODO: Add screenshot of wizard and tray icon -->
...
- [ ] Phase 5: Gateway WebSocket (remote monitoring)
- [ ] Phase 6: Native notifications, auto-update, GUI settings
